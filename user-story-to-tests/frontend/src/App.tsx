...
function App() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // include selected categories in request
      const request: GenerateRequest = { ...formData, categories: selectedCategories }
    ...
    <div>
      <style>{`
        * {
        ...
        .custom-check {
          width: 18px; height: 18px; border-radius: 4px; background: #fff; border: 1px solid #bbb;
          box-sizing: border-box; display: inline-block;
        }

        .category.selected { background: linear-gradient(180deg,#eef6ff,#f7fbff); border-color: #dbeeff; box-shadow: 0 1px 0 rgba(11,95,255,0.03); }
        .category.selected .custom-check { background: linear-gradient(180deg,#0b5fff,#0066ff); border-color: transparent; }
      ...
      <div className="container">
        ...
        <form onSubmit={handleSubmit} className="form-container">
          ...
          <div className="form-group">
            ...
            <CategorySelector
              categories={["Unit", "Integration", "End-to-End", "Component", "Performance", "Security"]}
